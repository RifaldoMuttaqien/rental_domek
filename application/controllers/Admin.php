...
class Admin extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('admin/header_copy');
	...
	function transaksi_add_act()
	{
		...
		$this->form_validation->set_rules('tgl_pinjam', 'Tanggal_Pinjam', 'required');
		$this->form_validation->set_rules('tgl_kembali', 'Tanggal_Kembali', 'required');
		...
		if ($this->form_validation->run() != false) {
			...
			// update data status mobil yg dipinjam 
			$d = array(
				'mobil_status' => '2'
			);
